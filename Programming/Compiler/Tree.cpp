...
int IsTreeValid ( TreeNode* ParentNode )
{
    ...
    {
        if ( ParentNode != ParentNode->Middle->Parent )
        {
            errno = ETSTRUCTERR;
            return -1;
        }
    ...
    if ( ParentNode->Parent != NULL )
    {
        ...
        if ( ParentNode->Parent->Middle != ParentNode )
        {
            errno = ETSTRUCTERR;
            return -1;
        }
    ...
    if ( ParentNode->Left != NULL && IsTreeValid ( ParentNode->Left ) == -1 )
        return -1;
    //****************************
    if ( ParentNode->Middle != NULL && IsTreeValid ( ParentNode->Middle ) == -1 )
        return -1;
    //****************************
...
int TreeOutInFile ( TreeNode* ParentNode )
{
    ...
    if ( ParentNode->Middle != NULL )
        TreeOutInFile ( ParentNode->Middle );
    else
        printf ( " NULL " );
...
int TreeDestroy ( TreeNode* ParentNode )
{
    ...
    if ( ParentNode->Middle != NULL )
    {
        TreeDestroy ( ParentNode->Middle );
        free( ParentNode->Middle );
    }
