...
{
    double Var2 = PopStack ( Stack );
    double Var1 = PopStack ( Stack );
    if ( PushStack ( Stack, Add ( Var1, Var2 ) ) != 0 )
        return -1;
...
int SUBst ( MyStack* Stack )
{
    double Var2 = PopStack ( Stack );
    double Var1 = PopStack ( Stack );
    if ( PushStack ( Stack, Sub ( Var1, Var2 ) ) != 0 )
        return -1;
...
int MULst ( MyStack* Stack )
{
    double Var2 = PopStack ( Stack );
    double Var1 = PopStack ( Stack );
    if ( PushStack ( Stack, Mul ( Var1, Var2 ) ) != 0 )
        return -1;
...
int DIVst ( MyStack* Stack )
{
    double Var2 = PopStack ( Stack );
    double Var1 = PopStack ( Stack );
    double Result = Div ( Var1, Var2 );
    if ( Result == -1 && errno != 0 )
        return -1;

    if ( PushStack ( Stack, Result ) != 0 )
        return -1;
...
int StackDump ( MyStack* Stack )
{
    ...
    case EDOM:
        ...
        break;
    case ENOMEM:
        printf ( "-----> No memory for expansion stack  \n\r" );
        IsOutStack = 1;
        break;
    default:
