...
int IsTreeValid ( TreeNode* ParentNode )
{
    ...
    //****************************
    if ( IsTreeValid ( ParentNode->Left ) == -1 )
        return -1;
    //****************************
    if ( IsTreeValid ( ParentNode->Right ) == -1 )
        return -1;
    //****************************
    return 0;
#endif
...
int TreeOutInFile ( TreeNode* ParentNode )
{
    ...
    printf ( "{ " );
    if ( ParentNode->Left != NULL ) TreeOutInFile ( ParentNode->Left );
    printf ( " } " );
    printf ( " { " );
    if ( ParentNode->Right != NULL ) TreeOutInFile ( ParentNode->Right );
    printf ( "}" );
    return 0;
}
/****************************************************************************/
